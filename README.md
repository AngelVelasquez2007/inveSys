[README.md](https://github.com/user-attachments/files/29121704/README.md)
...
1. Acceder a `http://127.0.0.1:5173/login` e iniciar sesión con el usuario administrador o registrar una cuenta nueva.
2. Navegar por el menú lateral entre los módulos: Dashboard, Productos, Categorías, Proveedores, Ventas, Clientes, Inventario y Auditoría.
3. Registrar movimientos de inventario y órdenes de venta; el sistema actualiza el stock automáticamente mediante los procedimientos almacenados.
4. Consultar el módulo de Auditoría para ver el historial de cambios capturado por los triggers de PostgreSQL.
5. Descargar reportes de ventas en PDF desde el módulo correspondiente, filtrando por rango de fechas.
