    ...
    <>
      <header className="page-header">
        <div>
          ...
          <p className="page-subtitle">Control de entradas, salidas y movimientos del inventario.</p>
        </div>
          ...
          <table>
            ...
            <tbody>
              ...
              {movimientos.length === 0 && (
                <tr>
                  <td colSpan="7" className="text-muted" style={{ textAlign: 'center', padding: '2rem' }}>Aún no hay movimientos de inventario registrados.</td>
                </tr>
              )}
            </tbody>
          </table>
