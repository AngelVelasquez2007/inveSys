    ...
    <>
      <header className="page-header">
        <div>
          ...
          <p className="page-subtitle">Historial de cambios y registro de actividad del sistema.</p>
        </div>
      </header>
        ...
        <div className="table-wrap">
          <table>
            ...
            <tbody>
              ...
              {eventos.length === 0 && (
                <tr>
                  <td colSpan="6" className="text-muted" style={{ textAlign: 'center', padding: '2rem' }}>Aún no hay eventos registrados en el sistema.</td>
                </tr>
              )}
            </tbody>
          </table>
